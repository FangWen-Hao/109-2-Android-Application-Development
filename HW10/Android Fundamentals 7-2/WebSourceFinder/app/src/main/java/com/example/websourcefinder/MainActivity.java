...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>, AdapterView.OnItemSelectedListener {
    ...
    public Loader<String> onCreateLoader(int i, @Nullable Bundle bundle) {
        ...
        return new SCLoader(this, queryString, transferProtocol);
    }
    ...
    public void onLoadFinished(@NonNull Loader<String> loader, String s) {
        ...
        mSourceCodeTextView.setVisibility(View.VISIBLE);
    }
    ...
    public void onNothingSelected(AdapterView<?> parent) {
        String[] values = getResources().getStringArray(R.array.protocol_array);
