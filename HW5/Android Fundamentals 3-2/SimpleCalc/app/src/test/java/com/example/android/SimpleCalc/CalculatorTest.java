...
public class CalculatorTest {
    ...
    public void powTwoNumbers(){
        double resultPow = mCalculator.pow(2d,10d);
        assertThat(resultPow, is(equalTo(1024d)));
    }

    @Test
    public void powNegFirstOperand(){
        double resultPow = mCalculator.pow(-2d,9d);
        assertThat(resultPow, is(equalTo(-512d)));
    }

    @Test
    public void powNegSecondOperand(){
    ...
    public void powZeroFirstOperand(){
        double resultPow = mCalculator.pow(0,10d);
