...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readFile(getResources().openRawResource(R.raw.names), mRecipeNames);
        readFile(getResources().openRawResource(R.raw.descriptions), mRecipeDesc);


        RecyclerView mRecyclerView = findViewById(R.id.recycler_view);
        mAdapter = new ListAdapter (this, mRecipeNames, mRecipeDesc);
