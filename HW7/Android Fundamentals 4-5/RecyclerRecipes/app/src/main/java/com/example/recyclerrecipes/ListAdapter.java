...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.RecipeViewHolder> {
    private final LinkedList<String> mRecipeName;
    private final LinkedList<String> mRecipeDesc;
    private LayoutInflater mLayoutInflater;
    public final static String EXTRA_NAME = "com.example.recyclerrecipes.EXTRA.NAME";
    ...
    class RecipeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        RecipeViewHolder(View itemView, ListAdapter adapter){
            super(itemView);
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(v.getContext(), RecipeMethod.class);
    ...
    ListAdapter(Context context, LinkedList<String> recipeName, LinkedList<String> recipeDesc){
    ...
    public RecipeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mItemView = mLayoutInflater.inflate(R.layout.recipes, parent, false);
        return new RecipeViewHolder(mItemView, this);
    }

    @Override
    public void onBindViewHolder(ListAdapter.RecipeViewHolder holder, int position) {
