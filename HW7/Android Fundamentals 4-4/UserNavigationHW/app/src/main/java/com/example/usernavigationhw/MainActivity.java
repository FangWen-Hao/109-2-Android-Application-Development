    ...
    public void onClickImage(View view) {
        ...
        switch (view.getId()){
            case R.id.imageView_donut :
                intent = new Intent(MainActivity.this, ActivityDonut.class);
                startActivity(intent);
                break;
            case R.id.imageView_froyo:
                intent = new Intent(MainActivity.this, ActivityFroyo.class);
                startActivity(intent);
                break;
            case R.id.imageView_ics:
                intent = new Intent(MainActivity.this, ActivityIceCream.class);
                startActivity(intent);
                break;
            case R.id.imageFour:
